  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="fixed inset-0 bg-white">
        {/* Larger animated blobs that extend beyond screen */}
        <div 
          className="absolute -top-1/2 -left-1/2 w-[1000px] h-[1000px] bg-purple-200/30 rounded-full mix-blend-multiply filter blur-3xl animate-blob"
          style={{ animationDuration: '15s' }}
        />
        <div 
          className="absolute -top-1/2 -right-1/2 w-[1000px] h-[1000px] bg-yellow-200/30 rounded-full mix-blend-multiply filter blur-3xl animate-blob"
          style={{ animationDuration: '25s', animationDelay: '-2s' }}
        />
        <div 
          className="absolute -bottom-1/2 left-1/4 w-[1000px] h-[1000px] bg-pink-200/30 rounded-full mix-blend-multiply filter blur-3xl animate-blob"
          style={{ animationDuration: '20s', animationDelay: '-5s' }}
        />
        <div 
          className="absolute -top-1/4 left-1/3 w-[800px] h-[800px] bg-blue-200/30 rounded-full mix-blend-multiply filter blur-3xl animate-blob-spin"
